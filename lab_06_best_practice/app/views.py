...
from lab_06_best_practice.app.models import Teacher, Student
from lab_06_best_practice.utils.serialize import deserialize, serialize
...
def save():
    ...
    if serialized_teacher is not None:
        ...
        resp.set_cookie("teacher", serialized_teacher, expires=expire_date)
